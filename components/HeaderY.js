  ...
  return (
    <header className="bg-gray-100/90 contianer shadow-md  ">
      <div className="py-4 px-[2vmax] lg:px-[4vmax]  flex flex-col gap-5 lg:flex-row lg:justify-between lg:items-center">
        ...
        <div
          className={`flex pb-2 duration-500 ease-in-out bg-gray-100/90 flex-col gap-5 absolute lg:static  ${
            open
              ? "top-14 left-0 pl-[2vmax] w-full z-10  shadow-md"
              : "top-[-100%] left-0"
          } lg:flex-row lg:justify-end lg:items-center lg:w-[70%]`}
        >
